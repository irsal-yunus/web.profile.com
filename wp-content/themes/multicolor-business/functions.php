...
//footer Link
define('MULTICOLOR_BUSINESS_LIVE_DEMO',__('https://luzukdemo.com/demo/multicolor-business-design/','multicolor-business'));
define('MULTICOLOR_BUSINESS_PRO_DOCS',__('https://luzukdemo.com/demo/multicolor-business-design/documentation/','multicolor-business'));
define('MULTICOLOR_BUSINESS_BUY_NOW',__('https://www.luzuk.com/product/business-wordpress-theme/','multicolor-business'));
...
function multicolor_business_sanitize_phone_number( $phone ) {
	return preg_replace( '/[^\d+]/', '', $phone );
}

function multicolor_business_sanitize_checkbox( $input ) {
	
	// Boolean check 
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function multicolor_business_sanitize_email( $email, $setting ) {
