...
<?php if( get_theme_mod('multicolor_business_slider_hide_show') != ''){ ?>	
	<section id="slider">
	  	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
		    <?php $multicolor_business_slider_pages = array();
		      	for ( $count = 1; $count <= 4; $count++ ) {
			        $mod = intval( get_theme_mod( 'multicolor_business_slider' . $count ));
			        if ( 'page-none-selected' != $mod ) {
			          	$multicolor_business_slider_pages[] = $mod;
			        }
		      	}
		      	if( !empty($multicolor_business_slider_pages) ) :
		        $args = array(
		          	'post_type' => 'page',
		          	'post__in' => $multicolor_business_slider_pages,
		          	'orderby' => 'post__in'
		        );
...
<section id="our-services">
	<div class="container">		
		<div class="service-box">
            ...
            <div class="row">
	      		<?php
	      		$multicolor_business_catData1=  get_theme_mod('multicolor_business_category_setting');
      			if($multicolor_business_catData1){ 
	      			$page_query = new WP_Query(array( 'category_name' => esc_html($multicolor_business_catData1 ,'multicolor-business')));?>
