							...
							<div class="contact-details">
								<span class="call">
									<?php if( get_theme_mod( 'multicolor_business_mail','' ) != '') { ?>
								    	<i class="fas fa-envelope"></i><span class="col-org"><a href="mailto:<?php echo esc_attr( get_theme_mod('multicolor_business_mail','') ); ?>"><?php echo esc_html( get_theme_mod('multicolor_business_mail','') ); ?></a></span>
									<?php } ?>
								</span>  							
						    </div>		
						</div>
							...
							<div class="contact-details1">
								<span class="call">
									<?php if( get_theme_mod( 'multicolor_business_call','' ) != '') { ?>
								    	<i class="fas fa-mobile-alt"></i><span class="col-org"><a href="tel:<?php echo esc_attr( get_theme_mod('multicolor_business_call','') ); ?>"><?php echo esc_html( get_theme_mod('multicolor_business_call','') ); ?></a></span>
									<?php } ?>
								</span>
						    </div>
						</div>
				      	...
				      	<div class="col-lg-9 col-md-8 col-3">
				      		<?php if (has_nav_menu('primary')){ ?>
								<div class="toggle-menu responsive-menu">
						            <button onclick="multicolor_business_open()" role="tab" class="mobile-menu"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','multicolor-business'); ?></span></button>
						        </div>
